...
/***/ function(module, exports, __webpack_require__) {
	...
	var InstanceStore = __webpack_require__(2);
	var RxGoogleMaps = __webpack_require__(7);
	var Utils = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	    ...
	    maps.ElevationService.prototype.getElevationAlongPathAsObservable = function (request) {
	        ...
	        this.getElevationAlongPath(request, function (elevationResults, elevationStatus) {
	    ...
	    maps.ElevationService.prototype.getElevationForLocationsAsObservable = function (request) {
	        var subject = new asyncSubject();
	        this.getElevationForLocations(request, function (elevationResults, elevationStatus) {
	            if (elevationStatus != maps.ElevationStatus.OK) {
	                subject.OnError(elevationStatus);
	            } else {
	                subject.OnNext(elevationResults);
	    ...
	    maps.Geocoder.prototype.geocodeAsObservable = function (request) {
	        var subject = new asyncSubject();
	        this.geocode(request, function (geocoderResults, geocoderStatus) {
	    ...
	    maps.DirectionsService.prototype.routeAsObservable = function (request) {
	        var subject = new asyncSubject();
	        this.route(request, function (directionsResults, directionsStatus) {
	    ...
	    maps.StreetViewService.prototype.getPanoramaById = function (pano) {
	        var subject = new asyncSubject();
	        this.getPanoramaById(pano, function (data, status) {
	    ...
	    maps.StreetViewService.prototype.getPanoramaByLocation = function (latlng, radius) {
	        var subject = new asyncSubject();
	        this.getPanoramaByByLocation(latlng, radius, function (data, status) {
	            if (status != maps.StreetViewStatus.OK) {
	                subject.OnError(status);
	            } else {
	                subject.OnNext(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10)(module), (function() { return this; }()), __webpack_require__(9)))
